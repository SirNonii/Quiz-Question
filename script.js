...
const quizQuestions = [
  ...
  {
    question: "What HTTP status code indicats that a resource was not found ?",
    answers: [
  ...
  },
  {
    ...
    answers: [
      ...
      { text: "Improve rendering performance", correct: true },
      { text: "Manage databases", correct: false },
      { text: "Handle authentication", correct: false },
    ],
  },
  {
    question: "Which SQL statement is used to retrive data from a dashbase ?",
    answers: [
